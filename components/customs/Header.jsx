  ...
  return (
    <div className="p-4 flex justify-between items-center">
      ...
      <div className="flex gap-5">
        <button className="inline-flex h-10 items-center justify-center rounded-md border border-gray-600 bg-transparent px-4 font-medium text-gray-300 hover:bg-gray-800/20 hover:border-gray-500 transition-colors focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-offset-2 focus:ring-offset-black">
          Sign In
        </button>
